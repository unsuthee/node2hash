...
model = EdgeRegOnly(dataset_name, num_features, num_nodes, num_bits, dropoutProb=0.1, device=device, T=args.num_samples)

#########################################################################################################
if num_samples == 1:
    saved_model_file = 'saved_models/node2hash_edge_only.{}.T{}.bit{}.pth'.format(dataset_name, num_samples, num_bits)
else:
    saved_model_file = 'saved_models/node2hash_edge_only_v2.{}.T{}.bit{}.pth'.format(dataset_name, num_samples, num_bits)
